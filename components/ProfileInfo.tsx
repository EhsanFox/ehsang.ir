...
export function ProfileCardInfo() {
  return (
    <div className="hidden xl:block xl:px-6 py-4">
      <h3 className="text-xl font-semibold text-gray-800 dark:text-white">Ehsan Golmakani</h3>
      <h5 className="py-2 text-gray-700 dark:text-gray-400">Mid-Level Typescript Engineer</h5>
      <div className="space-y-4 mt-4 mb-2">
        ...
        <div className="flex items-center text-gray-700 dark:text-gray-200">
          ...
          <p className="px-2">
            Mashhad, Iran
            <span className="align-middle flag-ir ml-1">
              <Twemoji emoji="flag-iran" />
            </span>
          </p>
        </div>
        <div className="flex items-center text-gray-700 dark:text-gray-200">
